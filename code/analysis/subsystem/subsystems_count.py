...
df = pd.read_csv("../../../results/fva_jaccardsimilarity/bin/lungtumour_vs_brainmetasis.txt", delimiter=";")
df = df[df["J"] > 0.1]
...
df = pd.read_csv("../../../results/fva_jaccardsimilarity/bin/lungtumour_vs_lungmetastasis(origin_breast).csv", delimiter=";")
...
df = pd.read_csv("../../../results/fva_jaccardsimilarity/bin/nonlungmetastasis_vs_lungmetastasis(origin_breast).csv", delimiter=";")
...
df = pd.read_csv("../../../results/fva_jaccardsimilarity/bin/MDA_MB_231_vs_lungmetastasis(origin_breast).csv", delimiter=";")
...
df = pd.read_csv("../../../results/fva_jaccardsimilarity/bin/MDA_MB_231_vs_nonlungmetastasis(origin_breast).csv", delimiter=";")
